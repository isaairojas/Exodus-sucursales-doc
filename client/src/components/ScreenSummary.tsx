  ...
  return (
    <div className="flex-1 p-8 overflow-auto" style={{ background: '#f3f4f6', animation: 'screenFadeIn 0.3s ease' }}>
      ...
      <div className="flex gap-6 mb-5 text-xs" style={{ color: '#6b7280' }}>
        ...
        <span>Revisor: <strong style={{ color: '#374151' }}>Cosme</strong></span>
      </div>

      {/* Stats grid */}
      <div className="grid grid-cols-3 gap-4 mb-5" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
        {[
              ...
              {state.unknownProducts.map(code => {
                ...
                return (
                  <tr key={code}>
                    ...
                    <td className="px-3 py-2.5 text-center" style={{ borderBottom: '1px solid #f0f0f0', color: '#9ca3af' }}>—</td>
                    <td className="px-3 py-2.5 text-center" style={{ borderBottom: '1px solid #f0f0f0', fontWeight: 600, color: '#374151' }}>{item.conteo}</td>
                    <td className="px-3 py-2.5 text-center" style={{ borderBottom: '1px solid #f0f0f0', fontWeight: 600, color: '#16a34a' }}>+{item.conteo}</td>
                    <td className="px-3 py-2.5" style={{ borderBottom: '1px solid #f0f0f0' }}>
                      <span className="font-semibold" style={{ color: '#d97706' }}>⚠ Producto incorrecto</span>
                    </td>
                  </tr>
                );
              })}
